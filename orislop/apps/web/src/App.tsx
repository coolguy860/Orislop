...
const WEB_RELEASE_LABEL = "Orislop 1.4";
    ...
    root.innerHTML = `
      <main class="site-shell">
        <header class="site-nav" aria-label="Primary navigation">
          ...
          <span class="model-pill"><i aria-hidden="true"></i> YouTube protection ready</span>
        </header>
        ...
        <section class="hero" id="top">
          <div class="hero__copy">
            ...
            <p class="eyebrow">Automatic YouTube cleanup</p>
            <h1>Open YouTube. Keep the good stuff.</h1>
            <p class="hero__subhead">
              Orislop starts automatically and filters AI clips, reposts, engagement bait, get-rich-quick
              funnels, and repetitive Shorts before they waste your time.
            </p>
            <div class="hero__actions">
              <a class="primary-link" href="./downloads/orislop-browser-extension.zip" download>Get Orislop for Chrome</a>
              <a class="secondary-link" href="#extension-download">How it works</a>
              <a class="secondary-link" href="#analyzer">Try the analyzer</a>
            </div>
            <div class="hero__trust-strip" aria-label="Product guarantees">
              <span>YouTube only</span>
              <span>Starts automatically</span>
              <span>No setup screens</span>
              <span>${WEB_RELEASE_LABEL}</span>
            </div>
            <div class="scope-banner" role="note">
              <strong>Focused MVP.</strong>
              Orislop supports YouTube and YouTube Shorts only. Filtering is on from the moment the extension loads;
              advanced visual checks use the Orislop companion in this MVP.
            </div>
        ...
        <section class="download-section panel" id="extension-download">
          <div class="download-copy">
            ...
            <h2>Install once. Open YouTube.</h2>
            <p>
              There is no onboarding flow and no filter-building required. Orislop starts with strong defaults,
              scans YouTube and Shorts as you browse, hides Skip-rated videos, and keeps a private activity history
              in your browser.
            </p>
            <dl class="definition-list">
              ...
              <div>
                ...
                <dd>Protection is enabled on install. Open YouTube and Orislop begins filtering immediately.</dd>
              </div>
            </dl>
          </div>
          <div class="download-card">
            ...
            <p class="prototype-note">
              This MVP uses the Orislop companion for full Heavy visual analysis. Developer mode is needed only
              for this direct-download build; after Chrome Web Store approval, extension installation is one click.
            </p>
          </div>
        </section>
        ...
        <section class="info-grid">
          ...
          <article class="panel" id="privacy">
            ...
            <ul class="privacy-list">
              ...
              <li>Full Heavy checks use the Orislop companion on your own device at 127.0.0.1.</li>
            </ul>
          </article>
        </section>
